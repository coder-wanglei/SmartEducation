...
Pod::Spec.new do |s|
  s.name             = 'SmartEducation'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SmartEducation.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/wanglei19940101/SmartEducation.git', :tag => s.version.to_s }
